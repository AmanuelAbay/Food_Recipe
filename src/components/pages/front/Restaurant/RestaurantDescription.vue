<template>
    <body>
        ...
        <div class="h-95 w-full">
            <img src="../../../../assets/images/restaurants/desc_image.jpg" alt="Kaldi's Coffee" class=" h-80 w-full object-cover">
        </div>

            <!-- descriptions below image -->
        <div class="block h-95 w-full text-start mt-9 px-20">
            <!-- detail description -->
        ...
        <div class="grid grid-cols-5 font-bold text-3xl pl-20 mt-3">
            <div class="col-span-3 flex justify-between">
                <div class="flex justify-start items-center capitalize">
